---
title: 'Protocols vs Programs'
publishedAt: '2021-05-13'
summary: "A review of Balaji's article Founding vs Inheriting."
image: '/the-path-to-web3.jpeg'
---

<Image
  alt={`Teach Online`}
  src={`/the-path-to-web3.jpeg`}
  width={1000}
  height={667}
  priority
/>

I've been following [1729](https://1729.com/) closely. It's a newsletter created by [Balaji Srinivasan](https://twitter.com/balajis) that lets you earn Bitcoin bounties for completing tasks and tutorials. I was skeptical at first but got hooked after earning $100 in Bitcoin for [this tweet](https://twitter.com/davidhurley87/status/1388499955502002178).
